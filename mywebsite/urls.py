...
urlpatterns = [
    ...
    path('register/', user_views.register, name='register'), # if go register -> then go to user_views.register
    ...
    path('password-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='users/password-confirm-done.html'),
